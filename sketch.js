...
var gameOver, gameOverI,reinicio,reinicioI;
...
function preload(){
  ...
  gameOverI = loadImage("gameOver0.png");
  //reinicioI = loadImage("gameover2.png");
}
...
function setup(){
  ...
  araña = new Araña(365,560,460);
  araña2 = new Araña(525,460,460);
  araña3 = new Araña(665,560,460);
  araña4 = new Araña(805,460,460);
  araña5 = new Araña(955,560,460);
  ...
  pieza3 = new Piezas(339,height-220, 20, 20);

  pieza4 = new Piezas(1310,height-100, 20, 20);

  pieza5 = new Piezas(133,height-550, 20, 20);

  pieza6 = new Piezas(1068,height-100, 20, 20);


  gameOver = createSprite(width/2,height/2);
  gameOver.addImage(gameOverI); 
  gameOver.visible = false;
  reinicio = createSprite(width/2,height/2+300);
...
function draw(){
  ...
  if(gameState===Nivel1){
    ...
    if(keyDown("LEFT_ARROW")&&gameState===Nivel1){
      alien1.move(-2,0);
    }
  }
  if(gameState===End_1){
...
function nivel1(){
  ...
  /*if(araña2.body.position.y<=560||araña4.body.position.y<=560){
    araña2.move(1);
    araña4.move(1);
  }
  else{
  ...
  if(araña.body.position.y<490||araña3.body.position.y<490||araña5.body.position.y<490){*/
    var choque3=[Matter.SAT.collides(piso.body,araña.body),Matter.SAT.collides(plataforma3.body,araña.body),];
   if(choque3[0].collided){
    araña.mover(-1);
   }
   else{
     araña.mover(1);
...
function chocar(){
  ...
  var choque2=[Matter.SAT.collides(pieza1.body,alien1.body),Matter.SAT.collides(pieza2.body,alien1.body),Matter.SAT.collides(pieza3.body,alien1.body),Matter.SAT.collides(pieza3.body,alien1.body),Matter.SAT.collides(pieza4.body,alien1.body),Matter.SAT.collides(pieza5.body,alien1.body),Matter.SAT.collides(pieza6.body,alien1.body)];
  if(choque2[0].collided||choque2[1].collided||choque2[2].collided||choque2[3].collided||choque2[4].collided||choque2[5].collided){
    score++;
    World.remove(world,pieza1);
  }
}
